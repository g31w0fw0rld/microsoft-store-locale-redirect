    ...
    const I18N = {
        es: {
            ...
            aboutBody: [
                ...
                'La preferencia de país/idioma se guarda en una cookie de microsoft.com (para que la lea apps.microsoft.com); el resto en localStorage. No se envían datos a ningún servidor.',
            ],
        },
        en: {
            ...
            aboutBody: [
                ...
                'The country/language preference is stored in a microsoft.com cookie (so apps.microsoft.com can read it); the rest in localStorage. No data is sent to any server.',
            ],
        },
    };
    const t = I18N[LANG];
